...
# Возьмем первую независиммую переменную size, так как она довольно сильно коррелирует с нашим tip
X = data_file[['total_bill', 'size']]

# Наша целевая переменная (зависимая переменная) - то, что мы хотим предсказать
y = data_file['tip']

# Разделяем данные на обучающую и тестовую выборки
# 80% данных идут на обучение модели, 20% - на проверку её точности
...
# Выводим коэффициенты модели (уравнение линейной регрессии)
